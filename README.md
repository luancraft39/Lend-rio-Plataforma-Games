...
<body>
  ...
  <div class="container">
    ...
    <!-- NOVO JOGO: PARKOUR X -->
    <div class="card">
      <img src="https://via.placeholder.com/250x150.png?text=Lendario+Parkour+X" alt="Lendário Parkour X">
      <h3>Parkour X</h3>
      <p>A experiência definitiva de parkour! Veloz, intenso e lendário.</p>
      <a href="https://luancraft39.github.io/Lend-rio-Parkour-X/" class="btn" target="_blank">Jogar Agora</a>
    </div>

    <div class="card">
      <img src="https://via.placeholder.com/250x150.png?text=Tower+das+Lendas+Roblox" alt="Tower das Lendas">
      <h3>Tower das Lendas</h3>
      <p>Suba até o topo e conquiste seu lugar entre as lendas no Roblox!</p>
      <a href="https://www.roblox.com/games/129538228131445/Tower-das-Lendas" class="btn" target="_blank">Jogar no Roblox</a>
    </div>
