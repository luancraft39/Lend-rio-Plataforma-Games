...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <span class="toggle" onclick="toggleVersions('parkourVersions')">⬇️ Mostrar Versões</span>
    ...
    <div class="card">
      ...
      <span class="toggle" onclick="toggleVersions('dashVersions')">⬇️ Mostrar Versões</span>
    ...
    <div class="card">
      ...
      <span class="toggle" onclick="toggleVersions('tetrisVersions')">⬇️ Mostrar Versões</span>
