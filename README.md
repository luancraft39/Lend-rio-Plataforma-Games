...
<body>
  ...
  <div class="container">
    ...
    <!-- PARKOUR X 10.1 -->
    <div class="card">
      <img src="https://via.placeholder.com/250x150.png?text=Lendario+Parkour+X+10.1" alt="Lendário Parkour X">
      <h3>Parkour X</h3>
      <p>Nova versão 10.1! A experiência definitiva de parkour.</p>
      <a href="https://luancraft39.github.io/Lend-rio-Parkour-X-10.1/" class="btn" target="_blank">Jogar Versão 10.1</a>
      
      <span class="toggle" onclick="toggleVersions('parkourXVersions')">⏬ Mostrar Versões</span>
      <div class="versions" id="parkourXVersions">
        <a href="https://luancraft39.github.io/Lend-rio-Parkour-X/" target="_blank">Versão 1.0 (Antiga)</a>
      </div>
    </div>
